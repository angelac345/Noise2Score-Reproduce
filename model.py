...
class Model(nn.Module): 
    ...
    def __init__(self, in_channel, out_channel): 
        ...
        self.pool1 = nn.Sequential(
            nn.Conv2d(in_channels=in_channel, out_channels=48, kernel_size=3, padding=1), 
        ...
        self.dec_conv = nn.Sequential(
            nn.Conv2d(in_channels=96+in_channel, out_channels=64, kernel_size=3, padding=1), 
            nn.LeakyReLU(0.1), 
            nn.Conv2d(in_channels=64, out_channels=32, kernel_size=3, padding=1), 
            nn.LeakyReLU(0.1), 
            nn.Conv2d(in_channels=32, out_channels=out_channel, kernel_size=3, padding=1), 
            nn.ReLU()
        )
